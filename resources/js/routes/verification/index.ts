...
* @see Http/Controllers/Auth/EmailVerificationPromptController.php:16
* @route '/verify-email'
*/
...
* @see Http/Controllers/Auth/VerifyEmailController.php:14
...
* @see Http/Controllers/Auth/EmailVerificationNotificationController.php:14
