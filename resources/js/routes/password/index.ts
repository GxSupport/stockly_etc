...
* @see app/Http/Controllers/Auth/PasswordResetLinkController.php:36
* @route '/forgot-password'
*/
...
* @see app/Http/Controllers/Auth/VerifyOtpController.php:19
...
* @see app/Http/Controllers/Auth/NewPasswordController.php:54
