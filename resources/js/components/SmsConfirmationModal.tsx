...
export default function SmsConfirmationModal({ isOpen, onClose, documentId, onSuccess }: SmsConfirmationModalProps) {
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {otpSent ? 'Введите код, отправленный в Telegram-бот для подтверждения' : 'Отправляем код подтверждения...'}
                    </DialogDescription>
                </DialogHeader>
