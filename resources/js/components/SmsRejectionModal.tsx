...
export default function SmsRejectionModal({ isOpen, onClose, documentId, onSuccess }: SmsRejectionModalProps) {
        ...
        <Dialog open={isOpen} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {otpSent ? 'Введите код, отправленный в Telegram-бот для подтверждения отказа' : 'Отправляем код подтверждения...'}
                    </DialogDescription>
                </DialogHeader>
                ...
                {otpSent ? (
                    <form onSubmit={handleSubmit}>
                        ...
                        <DialogFooter className="gap-2">
                            ...
                            <Button type="submit" variant="destructive" disabled={isSubmitting || !code || !note}>
