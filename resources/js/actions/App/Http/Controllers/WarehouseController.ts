...
* @see app/Http/Controllers/WarehouseController.php:67
...
* @see app/Http/Controllers/WarehouseController.php:46
* @route '/warehouses/{warehouse}/products'
*/
...
const WarehouseController = { index, create, store, show, products }
